...
interchangeable. The charter defines that research direction. The Work Package
2 main specification and distinct conformance document each carry version
`1.0.0` under their exact-head continuous-integration and final-Advisor
condition. No parallel-lab implementation, causal-twin study, scenario build,
evidence-generating run, or Work Package 3 activity is authorized.
...
| **Current work**                | The distinct Milestone 3 Work Package 2 [main specification and conformance document](documentation/milestones/003-parallel-causal-life-laboratory/work-packages/002-minimum-parallel-run-laboratory/README.md) each carry version `1.0.0`, valid only for the unchanged exact head after full CI succeeds and final Advisor clearance is recorded. Implementation, experiments, model calls, evidence generation, and Work Package 3 remain unauthorized. |
| **Current research direction**  | [`documentation/milestones/003-parallel-causal-life-laboratory/MILESTONE_003_RESEARCH_CHARTER.md`](documentation/milestones/003-parallel-causal-life-laboratory/MILESTONE_003_RESEARCH_CHARTER.md) — authoritative for research direction, claim boundaries, sequencing, and governance only                                                                                                                                                               |
...
| Kind                     | Documents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Research direction**   | [Milestone 3 research charter](documentation/milestones/003-parallel-causal-life-laboratory/MILESTONE_003_RESEARCH_CHARTER.md) — authoritative for current research direction and claim boundaries only                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Specification**        | [Vertical Slice 001 coding brief](documentation/reference/VERTICAL_SLICE_001_CODING_BRIEF.md) (authoritative); Milestone 3 Work Package 2 [package index](documentation/milestones/003-parallel-causal-life-laboratory/work-packages/002-minimum-parallel-run-laboratory/README.md), [main specification `1.0.0`](documentation/milestones/003-parallel-causal-life-laboratory/work-packages/002-minimum-parallel-run-laboratory/WORK_PACKAGE_002_MINIMUM_PARALLEL_RUN_LABORATORY_SPECIFICATION.md), and [conformance document `1.0.0`](documentation/milestones/003-parallel-causal-life-laboratory/work-packages/002-minimum-parallel-run-laboratory/WORK_PACKAGE_002_CONFORMANCE_REQUIREMENTS.md); [Milestone 2 brief](documentation/milestones/002-sparse-cognition/MILESTONE_002_SPARSE_COGNITION_AUTOMATION_IMPLEMENTATION_BRIEF.md) + [scope ruling](documentation/milestones/002-sparse-cognition/MILESTONE_002_SCOPE_RULING_AND_AMENDMENTS.md) (historical; authoritative for M2 only) |
