...
| Next authorized work     | None — Phase 4 (per-decision comparator) is unlocked but **not started**; formal Phase 4 work awaits explicit authorization                                  |
| Live model calls to date | Milestone 1 acceptance only; **no Milestone 2 live calls have been made** — evidentiary/live plans are refused until Phase 4 registers a formal profile      |
...
3. **Milestone 2 — sparse cognition** ([index](milestones/002-sparse-cognition/README.md)) —
   ...
   per-decision comparator (pending authorization). IN PROGRESS.
